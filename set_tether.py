...
# Set parameters for tether
set_and_verify_parameter(master, 'BAT_CRIT_THR', 0.500000000000000000, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_REAL32)
set_and_verify_parameter(master, 'BAT_EMERGEN_THR', 0.449999988079071045, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_REAL32)
set_and_verify_parameter(master, 'BAT_LOW_THR', 0.600000023841857910, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_REAL32)

set_and_verify_parameter(master, 'COM_DL_LOSS_T', 5, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_INT32)
set_and_verify_parameter(master, 'GF_MAX_VER_DIST', 45.000000000000000000, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_REAL32)
set_and_verify_parameter(master, 'MNT_MODE_IN', 0, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_INT32)
set_and_verify_parameter(master, 'NAV_DLL_ACT', 3, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_INT32)
set_and_verify_parameter(master, 'NAV_RCL_ACT', 0, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_INT32)
set_and_verify_parameter(master, 'RTL_RETURN_ALT', 0.000000000000000000, parm_type=mavutil.mavlink.MAV_PARAM_TYPE_REAL32)
